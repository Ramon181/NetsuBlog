            ...
            <div className="min-w-screen min-h-screen flex justify-center bg-gray-100 font-sans overflow-hidden">
                <div className="w-full lg:w-5/6">
                    ...
                    <div className="sm:flex items-center bg-white justify-between px-2 py-1 mt-6 mb-4">
                        ...
                        <Link to={"/characters-list/post"} className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-[#8549ba] hover:bg-[#6e3d99] focus:outline-none rounded-sm">
                        ...
                        <table className="min-w-max w-full  table-auto">
                            <thead>
                                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th className="py-3 px-6 text-left">Imagenes</th>
                                        ...
                                        <tr key={character.id} className=" border-b border-gray-200 hover:bg-gray-100">
                                            <td className="py-3 px-6 text-left whitespace-nowrap">
                                                <div className="flex items-center">
                                                    <div className="mr-2 transform  hover:scale-110">
                                                        <img className=" w-6 h-6 rounded-full" src={character.img} alt="" />
                                                    </div>
                                            ...
                                            <td className="py-3 px-6 text-left">
                                                <div className="flex items-center w-full justify-between min-w-0 max-w-[10rem]">
                                                    <span className="truncate font-medium">{character.description}</span>
                                                </div>
                                            </td>
                                            <td className="py-3 px-6 text-left">
                                            ...
                                            <td className="py-3 px-3 text-left">
                                                <div className="flex item-center justify-center">
                                                    {
                                                        character.images?.map((e, index) => (

                                                            <div key={index} className=" mr-2 transform  hover:scale-110">
                                                                <img className=" w-6 h-6 rounded-full" src={e.image} alt="" />
                                                            </div>
                                                        ))
                                                    }
                                            ...
                                            <td className="py-3 px-6 text-left">
                                                <span className="font-medium">{character.serie.name}</span>
                                            </td>
                                            <td className="py-3 px-6 text-left">
                                                <div className="flex items-center w-full justify-between min-w-0 max-w-[10rem]">
                                                    {
                                                        character.abilities?.map(event => (
                                                            <span key={event.id} className="truncate font-medium">{event.name}</span>
                                                        ))
                                                    }
                                                </div>
                                            </td>

const Delete = ({setClose, id, handleEliminarSerie}) => {
    return (
        <div
			...
			<div className="modal-content py-4 text-left px-6">
				...
				<div className="flex justify-between items-center pb-3">
					<p className="text-2xl font-bold text-gray-800">Exito</p>
					<div className="modal-close cursor-pointer z-50">
						<svg onClick={()=> setClose(false)} className="fill-current text-black" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
							viewBox="0 0 18 18">
							<path
				...
				<div className="my-5  text-gray-800">
					<p className='text-gray-800'>¡Los datos se han guardado con éxito! ¿Deseas crear otra serie?</p>
				</div>
				...
				<div className="flex justify-end pt-2">
					...
					<button onClick={()=> handleEliminarSerie(id)}
